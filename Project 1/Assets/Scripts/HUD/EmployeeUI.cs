...
namespace HUD
{
    ...
    public class EmployeeUI : MonoBehaviour, IReset
    {
        ...
        public void Reset()
        {
            this.purchaseHunter.resource.Owned = 0;
            this.purchaseLumberjack.resource.Owned = 0;
            this.purchaseMiner.resource.Owned = 0;

            this.purchaseHunter.resource.ClickLevel = this.purchaseHunter.resource.amountPerClick;
            this.purchaseLumberjack.resource.ClickLevel = this.purchaseLumberjack.resource.amountPerClick;
            this.purchaseMiner.resource.ClickLevel = this.purchaseMiner.resource.amountPerClick;
        }
    }
}